    ...
    <ScrollView>
      <View className="relative flex flex-1 size-full min-h-screen flex-col bg-white justify-between group/design-root overflow-x-hidden">
        <View>
          ...
          <Text className="text-[#111418] text-lg font-bold leading-tight tracking-[-0.015em] px-8 pb-2 pt-4">
            How it works
          </Text>
          <View className="pt-2 pb-2 pr-8 pl-8">
            <View className="flex flex-row items-start gap-x-2 w-full">
              {/* Left Side: Dot and Line */}
              <View className="flex items-center">
                <View className="w-[1.5px] h-4 " />
                <View className="w-2 h-2 rounded-full bg-[#111418] my-1" />
                <View className="w-[1.5px] flex-1 bg-[#dce0e5]" />
              </View>
              ...
              <View className="flex-1 pt-3 pb-5">
                <Text className="text-[#111418] text-base font-medium leading-normal">
                  ...
                  search and sent to your Metamask or other reputable and secure
                  web3 wallet.
                </Text>
              </View>
            </View>
            <View className="flex flex-row items-start gap-x-2 w-full">
              {/* Left Side: Dot and Line */}
              <View className="flex items-center">
                <View className="w-[1.5px] h-4 bg-[#dce0e5]" />
                <View className="w-2 h-2 rounded-full bg-[#111418] my-1" />
                <View className="w-[1.5px] flex-1 bg-[#dce0e5]" />
              </View>
            ...
            <View className="flex flex-row items-start gap-x-2 w-full">
              ...
              <View className="flex-1 pt-3 pb-5">
                <Text className="text-[#111418] text-base font-medium leading-normal">
                  This token has a 1:1 mapping of the amount of Co2 emissions
                  tons that we can get away with to stay under the 2 degrees
                  global warming by 2050. Current estimates mean there are 1
                  trillion tokens : 1 trillion mega tons of emissions to track
                  and reduce via the insuance of this token, similar to carbon
                  credits. The more tokens you earn, the greater impact we may
                  have on this seemingly impossible feat
                </Text>
              </View>
            </View>
            <View className="flex flex-row items-start gap-x-2 w-full">
              ...
              <View className="flex-1 pt-3 pb-5">
                <Text className="text-[#111418] text-base font-medium leading-normal">
                  ...
                  simple user friendly instructions later for those unware of
                  the basics of operating web3 wallets)
                </Text>
              </View>
            </View>
          </View>
          <View className="flex flex-1 flex-col pl-8 pr-8 pb-10">
