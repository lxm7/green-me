    ...
    <View className="relative flex flex-1 size-full min-h-screen flex-col bg-white justify-between group/design-root overflow-x-hidden">
      <View>
        ...
        <View className="grid grid-cols-[40px_1fr] gap-x-2 px-4">
          ...
          <View className="flex flex-1 flex-col pt-3 pb-5">
            <Text className="text-[#111418] text-base font-medium leading-normal">
              A breakdown of token reward is shown during the filters and search
              and send to your Metamask or other reputable and secure web3
              wallet
            </Text>
          </View>
          <View className="flex flex-col items-center gap-1 pb-3">
          ...
          <View className="flex flex-1 flex-col pt-3 pb-5">
            <Text className="text-[#111418] text-base font-medium leading-normal">
              ...
              tokens : 1 trillion mega tons of emissions to track and reduce via
              the insuance of this token, similar to carbon credits. The more
              tokens you earn, the greater impact we may have on this seemingly
              impossible feat
            </Text>
          </View>
          <View className="flex flex-col items-center gap-1 pb-3">
          ...
          <View className="flex flex-1 flex-col pt-3 pb-5">
            <Text className="text-[#111418] text-base font-medium leading-normal">
              This example of a web3 wallet in the chrome browser (a few simple
              user friendly instructions later for those unware of the basics of
              operating web3 wallets)
            </Text>
          </View>
        </View>
